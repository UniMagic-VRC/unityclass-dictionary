...
余談ですが、ヒューマノイドアバターで定義されているボーンの名前を他のオブジェクトで使うとエラーとなることがあります[^4] 。たとえば、アバターの顔の[メッシュ](/docs/索引/MNO/Mesh)にあたるオブジェクトの名前を「Head」にするとHeadボーンと名前の競合が起こり、リグ設定時にエラーとなります。
...
[^4]: https://signyamo.blog/unity_humanoid_error/
