...
なお、ボーンとアバターの位置関係の対応については、以下のハオランくん[^4] のボーン構造の図を参考にしてください(※各指のボーンは省略されていることに注意)。
...
余談ですが、ヒューマノイドアバターで定義されているボーンの名前を他のオブジェクトで使うとエラーとなることがあります[^5] 。たとえば、アバターの顔の[メッシュ](/docs/索引/MNO/Mesh)にあたるオブジェクトの名前を「Head」にするとHeadボーンと名前の競合が起こり、リグ設定時にエラーとなります。
